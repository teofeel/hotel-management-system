...
public class meni {
	public static void main(String[] args) {
		...
		System.out.println(RecepcionerManager.getInstance().izmenaStatusaRezrvacije("milica@example.com", "2024-05-27", "2024-06-03","Trokrevetna (2+1)", StatusRezervacije.POTVRDJENA));;
		...
		RecepcionerManager.getInstance().izmenaStatusaRezrvacije("ana@example.com", "2024-05-29", "2024-06-05","Trokrevetna (2+1)", StatusRezervacije.POTVRDJENA);

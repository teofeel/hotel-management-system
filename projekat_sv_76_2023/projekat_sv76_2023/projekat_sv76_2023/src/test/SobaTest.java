...
public class SobaTest {
	...
	public void pregledSlobodnihSoba() {
		boolean test = sm.pregledSlobodnihSoba(LocalDate.parse("2026-10-10"), LocalDate.parse("2026-10-15"), TipSobeEnum.DVOKREVETNA.toString());
		boolean test1 = sm.pregledSlobodnihSoba(LocalDate.parse("2026-10-10"), LocalDate.parse("2026-10-15"), TipSobeEnum.TROKREVETNA.toString());
		boolean test2 = sm.pregledSlobodnihSoba(LocalDate.parse("2026-10-10"), LocalDate.parse("2026-10-15"), TipSobeEnum.ODVOKREVETNA_DVA.toString());
		boolean test3 = sm.pregledSlobodnihSoba(LocalDate.parse("2026-10-10"), LocalDate.parse("2026-10-15"), TipSobeEnum.JEDNOKREVETNA.toString());
